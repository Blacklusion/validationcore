...
function checkConfig(): boolean {
  ...
  const settings = [
    ...
    ["general.is_master", "boolean"],
    ["general.slaves", "array"],
    ["general.slaves_port", "number"],
    ["general.slaves_authentication_token", "string"],
    ["general.instance_id", "number"],
    ...
    ["validation.validation_round_slave_delta", "number"],
    ["validation.request_delay", "number"],
    ["validation.request_retry_count", "number"],
    ["validation.request_retry_delay", "number"],
    ["validation.request_timeout_ms", "number"],
    ["validation.producer_limit", "number"],
    ["validation.seed_block_count", "number"],
    ["validation.seed_ok_speed", "number"],
    ["validation.seed_concurrent_validations", "number"],
    ...
    ["validation.atomic_tolerated_missing_blocks", "number"],
